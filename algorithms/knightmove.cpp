...
bool knightMove(int board[D][D], int movedNum, int curRow, int curCol){
	...
	int r[]={2,1,-1,-2,-2,-1,1,2};  //Take a note that the order of the x_move and y_move arrays are going to
	 								//affect the running time of the algorithm drastically. Think of a case, 
	                                //when a person chooses 6 wrong long paths and finally reaching the goal in the 
	                                //7th path and another case when the person took the correct path in the first turn.
